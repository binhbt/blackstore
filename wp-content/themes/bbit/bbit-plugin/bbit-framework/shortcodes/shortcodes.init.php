    ...
    class aafShortcodes
    {
        ...
        */
        public function __construct( $parent )
        {
			...
			$this->module_folder = $this->the_plugin->cfg['paths']['plugin_dir_url'] . 'bbit-framework/shortcodes/';
			$this->module_folder_path = $this->the_plugin->cfg['paths']['plugin_dir_path'] . 'bbit-framework/shortcodes/';
        ...
        public function admin_init() {
        	...
        	/*// css
        	wp_enqueue_style( 'bbit-shortcodes-popup', $this->module_folder .  'css/tinymce.popup.css', false, '1.0', 'all' );

        	// javascript
        	wp_enqueue_script( 'bbit-shortcodes-popup', $this->module_folder . 'js/tinymce.popup.js', array('jquery'), '1.0', false );*/
        	
        	wp_enqueue_style( 'bbit-shortcodes-plugin', $this->module_folder .  'css/tinymce.plugin.css', false, '1.0', 'all' );
			...
			$localize['plugin_btn_title'] = __('Bbit Plugin Shortcodes', $this->the_plugin->localizationName);
