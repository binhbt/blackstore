    ...
    class aafShortcodesPopup
    {
        ...
        */
		...
		private function buildHtmlPage() {
			...
			<div class="bbit-form bbit-shortcode-pop-up">
				...
				?>
					...
					<div class="bbit-button-row">
						...
						<?php echo '<input type="reset" value="' . __('Reset về mặc định', $bbit->localizationName) . '" class="bbit-button gray left" id="aff-reset-shortcode" />'; ?>
						<?php echo '<input type="submit" value="' . __('Insert shortcode', $bbit->localizationName) . '" class="bbit-button green bbit-saveOptions" id="aaf-insert-shortcode" />'; ?>
