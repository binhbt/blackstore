<?php
/*
* Define class bbitSocialSharingButtons
...
if (class_exists('bbitSocialSharingButtons') != true) {
	class bbitSocialSharingButtons
	{
		/*
		...
		*/
		...
		public function delicious_btn() {
			// $netUrl = '<a href="http://delicious.com/save" data-url="{URL}" data-title="{TITLE}"><span class="icon"></span><span class="bbit-sshare-delicious-count" style="{COUNT}">0</span></a>';
...
// Initialize the bbitSocialSharingButtons class
//$bbitSocialSharingButtons = new bbitSocialSharingButtons();
