...
class bbitListPagination
{
    ...
    function calculate()
    {
        ...
        if ($this->urlF and $this->urlF != '%' and strpos($this->target, $this->urlF) === false) {
            ...
            echo "There is no wild wildcard character specified in the target, to be sutstituted.<br />";
            $error = true;
        } elseif ($this->urlF and $this->urlF == '%' and strpos($this->target, $this->urlF) === false) {
            echo "It's necessary to specify the % character in target, to be substituted with the page number<br />";
            $error = true;
        }
