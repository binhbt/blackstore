...
if (class_exists('bbitSnippet_article') != true) {
    class bbitSnippet_article extends bbitRichSnippets
    {
        /*
...
// Initialize the bbitSnippet_article class
$bbitSnippet_article = new bbitSnippet_article('article');