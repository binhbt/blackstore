...
if (class_exists('bbitSnippet_recipe') != true) {
    class bbitSnippet_recipe extends bbitRichSnippets
    {
        /*
...
// Initialize the bbitSnippet_recipe class
$bbitSnippet_recipe = new bbitSnippet_recipe('recipe');