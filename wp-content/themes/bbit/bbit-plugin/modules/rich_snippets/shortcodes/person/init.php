...
if (class_exists('bbitSnippet_person') != true) {
    class bbitSnippet_person extends bbitRichSnippets
    {
        /*
...
// Initialize the bbitSnippet_person class
$bbitSnippet_person = new bbitSnippet_person('person');