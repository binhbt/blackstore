...
if (class_exists('bbitSnippet_product') != true) {
    class bbitSnippet_product extends bbitRichSnippets
    {
        /*
...
// Initialize the bbitSnippet_product class
$bbitSnippet_product = new bbitSnippet_product('product');