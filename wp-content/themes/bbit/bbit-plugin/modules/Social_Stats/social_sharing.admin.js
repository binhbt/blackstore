...
bbitSocialSharingAdmin = (function ($) {
"use strict";
...
(function init() {
	...
	$(document).ready(function(){
		...
		socialBox = maincontainer.find('#bbit-ajax-response');
		socialBoxResp = socialBox.find('#bbit-socialsharing-ajax');
...
function get_options( tbl ) {
	...
	$.post(ajaxurl, {
		...
		if ( response.status == 'valid' ) {
			...
			socialBoxResp.find('#bbit-status-box').remove();
...
function triggers()
{
	var tblWrap = socialBox.find('ul.bbit-socialshare-tbl-tabs'),
	...
	socialBox.on('click', '.bbit-saveOptions', function(e) {
