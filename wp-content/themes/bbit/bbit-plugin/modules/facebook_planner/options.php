 ...
 *  
 */
if ( !function_exists( 'bbit_wplanner_fb_options' ) ) {
	...
	function bbit_wplanner_fb_options() 
	{
		global $wpdb, $bbit;
		...
		$inputs_available = array(
			"message" => __( "Message", $bbit->localizationName ), 
			"caption" => __( "Caption", $bbit->localizationName ), 
			"image" => __( "Image", $bbit->localizationName )
		);
							
		// Facebook privacy options
		$wplannerfb_post_privacy_options = array(
			"EVERYONE" => __( 'Everyone', $bbit->localizationName ), 
			"EVERYONE" => __( 'Everyone', $bbit->localizationName ), 
			"ALL_FRIENDS" => __( 'All Friends', $bbit->localizationName ), 
			"NETWORKS_FRIENDS" => __( 'Networks Friends', $bbit->localizationName ), 
			"FRIENDS_OF_FRIENDS" => __( 'Friends of Friends', $bbit->localizationName ),
			"CUSTOM" => __( 'Private (only me)', $bbit->localizationName )
		);
		...
		$fb_user_pages_groups = get_option('bbit_fb_planner_user_pages');
		...
		$options = array(
			...
			'inputs_available' => array(
				"title" => __( "Publish on facebook optional fields", $bbit->localizationName ),
				"desc" => __( "What inputs do you want to be available for posting to facebook? It will appear on page/post details", $bbit->localizationName ),
				'size' 	=> 'large',
				'force_width'=> '130',
				"type" => "multiselect",
			...
			'featured_image_size' => array(
				"title" => __( "Custom Image size", $bbit->localizationName ),
				'std' => '450x320',
				"desc" => __( "WIDTH x HEIGHT (Without measuring units. Example: 450x320)", $bbit->localizationName ),
				'force_width'=> '180',
				'size' 	=> 'large',
				"type" => "text" 
			),
			...
			'featured_image_size_crop' => array(
				"title" => __( "Crop image?", $bbit->localizationName ),
				"desc" => __( "If yes, the image will crop to fit the above desired size. If no, the image will just resize with the dimensions provided.", $bbit->localizationName ),
				"type" => 'select',
				'size' 	=> 'large',
				'force_width'=> '140',
				"options" => array(
			...
			'default_privacy_option' => array(
				"title" => __( "Publish on facebook default privacy option", $bbit->localizationName ),
				"desc" => __( "What privacy option would you like to be default when you're posting to facebook? This option can also be adjusted manually when setting the scheduler for each post/page.", $bbit->localizationName ),
				'size' 	=> 'large',
				'force_width'=> '150',
				"type" => "select",
			...
			'email' => array(
				"title" => __( "Admin email", $bbit->localizationName ),
				'size' 	=> 'large',
				'force_width'=> '200',
				"desc" => __( "Notify this email adress each time you post something on facebook.", $bbit->localizationName ),
				"type" => "text"
			),
			
			'email_subject' => array(
				"title" => __( "Admin email subject", $bbit->localizationName ),
				'size' 	=> 'large',
				'force_width'=> '240',
				"desc" => __( "Subject for plugin email notification.", $bbit->localizationName ),
				"type" => "text"
			),
			
			
			'email_message' => array(
				"title" => __( "Admin email message", $bbit->localizationName ),
				'size' 	=> 'large',
				'force_width'=> '340',
				"desc" => __( "Email content for plugin notification.", $bbit->localizationName ),
				"type" => "textarea"
			),
			
			'timezone' => array(
				"title" => __( "Cron timezone", $bbit->localizationName ),
				"desc" => __( "Use valid timezone format from <a href='http://php.net/manual/en/timezones.php' target='_blank'>php.net</a>. E.g: America/Detroit", $bbit->localizationName ),
				"type" => "select",
				'size' 	=> 'large',
				'force_width'=> '150',
			...
			'info' => array(
				"html" => __( "
					...
					<p>You need to create a Facebook App. You can do that <a href='http://developers.facebook.com' target='_blank'>here.</a> and enter its details in to the fields below.</p>", $bbit->localizationName ),
				"type" => "message"
			),
			
			'auth' => array(
				"desc" => __( "Facebook Application authorization for cron job.", $bbit->localizationName ),
				"type" => "authorization_button",
				'size' 	=> 'large',
				'value' =>  __( "Authorization facebook app", $bbit->localizationName )
			),
			
			'app_id' => array(
				"title" => __( "Facebook App ID", $bbit->localizationName ),
				"desc" => __( "Insert your Facebook App ID here.", $bbit->localizationName ),
				"std" => "",
				'size' 	=> 'large',
				'force_width'=> '250',
				"type" => "text"
			...
			'app_secret' => array(
				"title" => __( "Facebook App Secret.", $bbit->localizationName ),
				"desc" => __( "Insert your Facebook App Secret here.", $bbit->localizationName ),
				"std" => "",
				'size' 	=> 'large',
				'force_width'=> '350',
				"type" => "text"
			...
			'redirect_uri' 	=> array(
				'type' 		=> 'text',
				'std' 		=> home_url( '/bbit_seo_fb_oauth' ),
				'size' 		=> 'large',
				'readonly'	=> true,
				'title' 	=> __('Redirect URI:', $bbit->localizationName),
				'desc' 		=> __('Url to your app.', $bbit->localizationName)
			),
			
			'language' => array(
				"title" => __( "Facebook Language", $bbit->localizationName ),
				"desc" => __( "Select the language for Facebook. More Information about the languages can be found <a target='_blank' href='http://developers.facebook.com/docs/internationalization/'>here</a>.", $bbit->localizationName ),
				"std" => "en_US",
				"type" => "select",
				'size' 	=> 'large',
				'force_width'=> '150',
			...
			'last_status' 	=> array(
				...
				'desc' 		=> __('Last Status retrieved from Facebook, for the Authorize operation', $bbit->localizationName)
			)
		...
		if( isset($fb_all_user_pages_groups) && count($fb_all_user_pages_groups) > 0 ) {
			...
			if(count($fb_all_user_pages_groups->pages) > 0) {
				...
				$options['available_pages'] = array( 
					"title" => __( "What pages do you want to be available when publishing?", $bbit->localizationName ),
					"desc" => __( "<strong>This option only works if the \"Filter Pages\" option from above is \"Yes\"</strong>", $bbit->localizationName ),
					"type" => "multiselect",
					'size' 	=> 'large',
					'force_width'=> '350',
			...
			if(count($fb_all_user_pages_groups->groups) > 0) {
				...
				$options['available_groups'] = array( 
					"title" => __( "What groups do you want to be available when publishing?", $bbit->localizationName ),
					"desc" => __( "<strong>This option only works if the \"Filter Groups\" option from above is \"Yes\"</strong>", $bbit->localizationName ),
					"type" => "multiselect",
					'size' 	=> 'large',
					'force_width'=> '350',
	...
	array(
		$tryed_module['db_alias'] => array(
			...
			'facebook_planner' => array(
				...
				// tabs
				'tabs'	=> array(
					'__tab1'	=> array(__('General setup', $bbit->localizationName), 'inputs_available,default_privacy_option,timezone'),
					'__tab2'	=> array(__('Facebook Settings', $bbit->localizationName), 'info,auth,app_id,app_secret,redirect_uri,language,last_status'),
					'__tab3'	=> array(__('Facebook - Pages', $bbit->localizationName), 'page_filter,available_pages'),
					'__tab4'	=> array(__('Facebook - Groups', $bbit->localizationName), 'group_filter,available_groups'),
					'__tab5'	=> array(__('Email Notification', $bbit->localizationName), 'email,email_subject,email_message'),
					'__tab6'	=> array(__('Facebook Image size', $bbit->localizationName), 'featured_image_size,featured_image_size_predefined,featured_image_size_crop'),
					'__tab7'	=> array(__('Cron Jobs Setup', $bbit->localizationName), 'cronjob_setup_help')
				),
				
				
				// create the box elements array
				'elements'	=> bbit_wplanner_fb_options()
			)
		)
	)
);