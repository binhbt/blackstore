...
class bbit_PlannerCron
{
    ...
    public static function getInstance()
    {
        if (!isset(self::$instance)) {
            self::$instance = new bbit_PlannerCron;
        }
	...
	public function __construct(){
		...
		self::$fbUtils = bbit_fbPlannerUtils::getInstance();
		...
		self::$utils = array(
			...
			'cron'				=> array(
				'table'			=> self::$db->prefix . 'bbit_post_planner_cron',
...
$bbit_PlannerCron = bbit_PlannerCron::getInstance();

// try to get non running tasks and execute then
echo $bbit_PlannerCron->wplanner_run_cron();
