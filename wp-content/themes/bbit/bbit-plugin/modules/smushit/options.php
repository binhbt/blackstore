			...
			'smushit' => array(
				...
				'elements'	=> array(
					...
					'resp_timeout' 	=> array(
						...
						'size' 		=> 'large',
						'force_width'=> '150',
						'title' 	=> __('Response timeout: ', $bbit->localizationName),
						'desc' 		=> __('enter the maximum number of seconds you want to wait for response from Smush.it service.', $bbit->localizationName)
					),
					'do_upload' => array(
						'type' 		=> 'select',
						'std' 		=> 'yes',
						'size' 		=> 'large',
						'force_width'=> '120',
						'title' 	=> __('Smush.it on Upload: ', $bbit->localizationName),
						'desc' 		=> __('smush.it on media image upload', $bbit->localizationName),
						'options'	=> array(
					...
					'same_domain_url' => array(
						...
						'size' 		=> 'large',
						'force_width'=> '120',
						'title' 	=> __('Image same domain: ', $bbit->localizationName),
						'desc' 		=> __('image url must be on same domain as website home url!', $bbit->localizationName),
						'options'	=> array(
							'yes' 		=> __('YES', $bbit->localizationName),
							'no' 		=> __('NO', $bbit->localizationName)
						)
