...
if (class_exists('bbitSetupBackup') != true) {
    class bbitSetupBackup
    {
        /*
...
// Initialize the bbitSetupBackup class
$bbitSetupBackup = new bbitSetupBackup($this->cfg);