...
--
-- Table structure for table `{wp_prefix}bbit_link_builder`
--

CREATE TABLE IF NOT EXISTS `{wp_prefix}bbit_link_builder` (
...
--
-- Table structure for table `{wp_prefix}bbit_link_redirect`
--

CREATE TABLE IF NOT EXISTS `{wp_prefix}bbit_link_redirect` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `hits` int(10) DEFAULT '0',
...
--
-- Table structure for table `{wp_prefix}bbit_monitor_404`
--

CREATE TABLE IF NOT EXISTS `{wp_prefix}bbit_monitor_404` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `{wp_prefix}bbit_web_directories`
--

CREATE TABLE IF NOT EXISTS `{wp_prefix}bbit_web_directories` (
...
--
-- Table structure for table `{wp_prefix}bbit_serp_reporter`
--

CREATE TABLE IF NOT EXISTS `{wp_prefix}bbit_serp_reporter` (
	`id` INT(10) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `{wp_prefix}bbit_serp_reporter2rank`
--

CREATE TABLE IF NOT EXISTS `{wp_prefix}bbit_serp_reporter2rank` (
	`id` INT(10) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `{wp_prefix}bbit_post_planner_cron`
--

CREATE TABLE IF NOT EXISTS `{wp_prefix}bbit_post_planner_cron` (
