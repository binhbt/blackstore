...
if (class_exists('bbitSocialTags') != true) {
    class bbitSocialTags extends bbitTitleMetaFormat
    {
        /*
	    ...
	    * Singleton pattern
	    *
	    * @return bbitSocialTags Singleton instance
	    */
...
// Initialize the bbitSocialTags class
$bbitSocialTags = new bbitSocialTags();