<?php
/*
* Define class bbitDashboardAjax
...
if (class_exists('bbitDashboardAjax') != true) {
    class bbitDashboardAjax extends bbitDashboard
    {
        ...
        */
        public function __construct( $the_plugin=array() )
        {
			...
			// ajax  helper
			add_action('wp_ajax_bbitDashboardRequest', array( &$this, 'ajax_request' ));
		}
		...
		*/
		public function ajax_request()
		{
			...
			/*if( in_array( 'social_impact', $actions) ){
				...
				$html = array();
				$html[] = '<ul class="bbit-lists-status">';
				
				$html[] = 	'<li style="color: #00102c">';
				$html[] = 	'<img src="' . ( $this->module_folder ) . 'assets/stats/alexa-icon.png" class="bbit-lists-icon">';
				...
				$html[] = 	'<img src="' . ( $this->module_folder ) . 'assets/stats/facebook-icon.png" class="bbit-lists-icon">';
				...
				$html[] = '<li style="color: #3c5b9b">';
				$html[] = 	'<img src="' . ( $this->module_folder ) . 'assets/stats/facebook-like-icon.png" class="bbit-lists-icon">';
				...
				$html[] = '<li style="color: #3c5b9b">';
				$html[] = 	'<img src="' . ( $this->module_folder ) . 'assets/stats/facebook-comments-icon.png" class="bbit-lists-icon">';
				...
				$html[] = 	'<img src="' . ( $this->module_folder ) . 'assets/stats/google-icon.png" class="bbit-lists-icon">';
				$html[] = 	'<span>' . ( isset($social_data['google']) ? number_format((float) $social_data['google'], 0) : '&ndash;' ) . '</span>';
				$html[] = 	'<label>' . ( __("shares", $this->the_plugin->localizationName) ) . '</label>';
				$html[] = '</li>';
				
				$html[] = '<li style="color: #00aced">';
				$html[] = 	'<img src="' . ( $this->module_folder ) . 'assets/stats/twitter-icon.png" class="bbit-lists-icon">';
				...
				$html[] = 	'<img src="' . ( $this->module_folder ) . 'assets/stats/linkedin-icon.png" class="bbit-lists-icon">';
				...
				$html[] = 	'<img src="' . ( $this->module_folder ) . 'assets/stats/pinterest-icon.png" class="bbit-lists-icon">';
				...
				$html[] = 	'<img src="' . ( $this->module_folder ) . 'assets/stats/stumbleupon-icon.png" class="bbit-lists-icon">';
				...
				$html[] = 	'<img src="' . ( $this->module_folder ) . 'assets/stats/delicious-icon.png" class="bbit-lists-icon">';
				...
				$html[] = '<span class="bbit-cache-info">Generated on <strong>' . ( date("F j, Y, g:i a", $social_data['_cache_date']) ) . '</strong></span>';
		...
		/*private function getSocialsData( $website_url='', $force_refresh_cache=false )
		{
			...
			$the_db_cache = $this->the_plugin->get_theoption( "bbit_dashboard_social_statistics" );
			...
			$this->the_plugin->save_theoption( 'bbit_dashboard_social_statistics', $db_cache );
