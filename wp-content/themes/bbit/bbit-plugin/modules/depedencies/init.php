    ...
    class bbitDashboard
    {
        ...
        */
        public function __construct()
        {
			...
			$this->addBox( 'aateam_products', 'Sản phẩm của Bbit:', $this->aateam_products(), array(
				'size' => 'grid_4'
			) );
	    ...
	    */
		...
		{
			$html = array();
			$html[] = '<a href="http://bbit.vn" target="_blank"><img src="' . ( $this->module_folder ) . 'assets/support_banner.jpg"></a>';
		...
		public function aateam_products()
		{
			...
			$html[] = '<ul class="bbit-aa-products-tabs">';
			$html[] = 	'<li class="on">';
			$html[] = 		'<a href="javascript: void(0)" class="bbit-aa-items-codecanyon">CodeCanyon</a>';
			$html[] = 	'</li>';
			$html[] = 	'<li>';
			$html[] = 		'<a href="javascript: void(0)" class="bbit-aa-items-themeforest">ThemeForest</a>';
			$html[] = 	'</li>';
			$html[] = 	'<li>';
			$html[] = 		'<a href="javascript: void(0)" class="bbit-aa-items-graphicriver">GraphicRiver</a>';
			$html[] = 	'</li>';
			$html[] = '</ul>';
