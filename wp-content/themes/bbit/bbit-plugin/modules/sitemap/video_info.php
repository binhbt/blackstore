...
if (class_exists('bbitVideoInfo') != true) {
    class bbitVideoInfo
    {
        /*
	    ...
	    */
	    ...
	    private function remote_get( $api_url, $output='default' ) {
	    	...
	    	$getdata = $bbit->remote_get( $api_url, 'default' );
...
// Initialize the bbitVideoInfo class
$bbitVideoInfo = new bbitVideoInfo();