...
// Initialize the bbitMisc class
//$bbitMisc = new bbitMisc($this->cfg, ( isset($module) ? $module : array()) );
$bbitMisc = bbitMisc::getInstance( $this->cfg, ( isset($module) ? $module : array()) );