...
if (class_exists('bbitFrontend') != true) {
    class bbitFrontend
    {
        /*
        ...
        */
		...
		public function do_virtual_robots() {
			...
			$option = $this->the_plugin->get_theoption('bbit_sitemap');
...
//$bbitFrontend = new bbitFrontend();
$bbitFrontend = bbitFrontend::getInstance();